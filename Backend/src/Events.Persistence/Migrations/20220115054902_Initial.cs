...
namespace Events.Persistence.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PanelistsEvents",
                columns: table => new
                {
                    PanelistId = table.Column<int>(type: "INTEGER", nullable: false),
                    EventId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PanelistsEvents", x => new { x.EventId, x.PanelistId });
                    table.ForeignKey(
                        name: "FK_PanelistsEvents_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PanelistsEvents_Panelists_PanelistId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventId = table.Column<int>(type: "INTEGER", nullable: true),
                    PanelistId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PanelistsEvents_PanelistId",
                table: "PanelistsEvents",
                column: "PanelistId");
